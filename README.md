...
- Easy to modify (plain HTML/CSS/JS, no build)

## Highlights

- 100% client-side: no servers, no accounts
- Supporst audio formats: MP3, WAV, OGG, M4A, FLAC
- Clean UIO with themes and light/dark mode
- Picture-in-Picture (PiP) mini-player with visualizer
- Offline single-file build included

## Features

- Upload local audio files by browsing or drag and drop
- Playlist management with persistent data stored in browser
...
1. Drop audio files into the upload area or use **Browse Files**.
2. Click a track to play or click the play/pause button to start playing your songs
...
- `contact.html` - support page for reporting bugs
...
- Audio files are loaded locally and are not uploaded to a server.
